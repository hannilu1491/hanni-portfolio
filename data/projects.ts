...
export const projects: Project[] = wixImportedProjects.map((project): Project => ({
  ...project,
  ...
  sections:
    (project.sections as ProjectSection[] | undefined) ?? [
      {
        type: 'text-image',
        title: 'Overview 專案概覽',
      ...
      },
      {
        ...
        title: 'Visual Highlights 視覺亮點',
        body: project.visualSystem,
        images: project.galleryImages.slice(0, 2)
      },
      {
        type: 'full-width-image',
        title: 'Final Outcome 最終成果',
