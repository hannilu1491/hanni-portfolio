...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-warm-200/80 bg-warm-50/95 backdrop-blur-md">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <ul className="hidden items-center gap-8 text-sm md:flex">
          <li><Link href="/" className="transition hover:text-caramel">Home</Link></li>
          <li className="group relative">
            <Link href="/projects" className="transition hover:text-caramel">Projects</Link>
      ...
      {open && (
        <div className="space-y-2 border-t border-warm-200 px-6 py-4 text-sm md:hidden">
          ...
          <Link href="/resume" className="block">Resume</Link>
